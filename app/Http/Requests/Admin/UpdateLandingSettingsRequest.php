...
class UpdateLandingSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'category_one_id'   => ['nullable', 'integer', 'exists:categories,id'],
            'show_category_two' => ['nullable', 'boolean'],
            'category_two_id'   => ['nullable', 'integer', 'exists:categories,id'],
            'show_khutab'       => ['nullable', 'boolean'],
            'khutab_category_id' => ['nullable', 'integer', 'exists:categories,id'],
