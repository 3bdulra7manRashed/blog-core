...
<div class="container mx-auto px-4 max-w-5xl py-8">
    ...
    <div class="flex flex-col md:flex-row gap-8 mb-8">
        ...
        <div class="w-full md:w-1/3 flex-shrink-0">
            ...
            @else
                <div class="aspect-[3/4] rounded-lg bg-gradient-to-br from-brand-secondary to-brand-primary flex items-center justify-center shadow-lg">
    ...
    @if($book->description)
        <div class="border-t border-gray-200 pt-8">
            <h2 class="text-xl font-bold text-brand-primary mb-4">عن الكتاب</h2>
    ...
    <div class="mt-12 pt-6 border-t border-gray-200">
        <a href="{{ route('books.index') }}" class="inline-flex items-center text-brand-accent hover:text-brand-primary transition-colors">
            <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
            </svg>
            العودة لقائمة الإصدارات
        </a>
    </div>
</div>
@endsection
