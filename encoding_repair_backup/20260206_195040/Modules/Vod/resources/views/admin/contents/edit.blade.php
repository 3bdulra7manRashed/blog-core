...
@section('title', 'طھط¹ط¯ظٹظ„ ط§ظ„ظ…ط­طھظˆظ‰: ' . $content->title)

@section('content')
<div class="mb-6 flex items-center justify-between">
    <h1 class="text-3xl font-serif font-bold text-brand-primary">طھط¹ط¯ظٹظ„: {{ Str::limit($content->title, 40) }}</h1>
    <div class="flex gap-2">
        <a href="{{ $content->route }}" target="_blank" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 bg-white hover:bg-gray-50 transition-colors">ظ…ط¹ط§ظٹظ†ط©</a>
        <a href="{{ route('admin.vod.contents.index') }}" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 bg-white hover:bg-gray-50 transition-colors">ط§ظ„ط¹ظˆط¯ط© ظ„ظ„ظ‚ط§ط¦ظ…ط©</a>
    </div>
</div>
    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="w-full lg:w-2/3 space-y-6">
            ...
            <div class="bg-white p-6 rounded shadow">
                <!-- Title -->
                <div class="mb-4">
                    <label for="title" class="block text-sm font-medium text-gray-700 mb-2">ط§ظ„ط¹ظ†ظˆط§ظ†</label>
                    <input type="text" name="title" id="title" value="{{ old('title', $content->title) }}" 
                           ...
                           placeholder="ط£ط¯ط®ظ„ ط§ظ„ط¹ظ†ظˆط§ظ† ظ‡ظ†ط§" required>
                ...
                <!-- Embed Code -->
                <div>
                     <label for="embed_code" class="block text-sm font-medium text-gray-700 mb-2">ظƒظˆط¯ ط§ظ„طھط¶ظ…ظٹظ† / ط§ظ„ط±ط§ط¨ط·</label>
                     ...
                     <p class="mt-1 text-xs text-gray-500">ط¶ط¹ ظƒظˆط¯ ط§ظ„طھط¶ظ…ظٹظ† (iframe) ط£ظˆ ط±ط§ط¨ط· ط§ظ„ظپظٹط¯ظٹظˆ/ط§ظ„طµظˆطھ.</p>
            ...
            <!-- Content Editor -->
            <div class="bg-white p-6 rounded shadow">
                <label for="description" class="block text-sm font-medium text-gray-700 mb-2">ط§ظ„ظˆطµظپ / ط§ظ„ظ…ط­طھظˆظ‰</label>
        ...
        <div class="w-full lg:w-1/3 space-y-6">
            ...
            <!-- Type Box -->
            <div class="bg-white p-4 rounded shadow">
                <h3 class="font-bold text-gray-800 mb-4 border-b pb-2">ط§ظ„ظ†ظˆط¹</h3>
                <div class="space-y-2">
                    <label class="flex items-center space-x-2 space-x-reverse cursor-pointer hover:bg-gray-50 p-1 rounded">
                        ...
                        <span class="text-sm text-gray-700 select-none">ظپظٹط¯ظٹظˆ (Video)</span>
                    </label>
                    <label class="flex items-center space-x-2 space-x-reverse cursor-pointer hover:bg-gray-50 p-1 rounded">
                        ...
                        <span class="text-sm text-gray-700 select-none">طµظˆطھ (Audio)</span>
                    </label>
                </div>
            </div>
