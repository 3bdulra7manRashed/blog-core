    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden">
        <div class="p-6 space-y-6">
            ...
            <div>
             ...
             <!-- Type -->
            <div>
                <label for="type" class="block text-sm font-medium text-gray-700 mb-1">نوع المحتوى</label>
                <select name="type" id="type" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-brand-accent focus:border-brand-accent">
        ...
        <div class="bg-gray-50 px-6 py-4 flex items-center justify-end gap-3">
             <a href="{{ route('admin.vod.contents.index') }}" class="px-4 py-2 text-gray-700 hover:text-gray-900 font-medium">إلغاء</a>
