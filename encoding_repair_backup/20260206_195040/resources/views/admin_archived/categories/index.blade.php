...
@section('title', 'ط§ظ„ط£ظ‚ط³ط§ظ…')

@section('content')
<div class="mb-6 flex items-center justify-between">
    <h1 class="text-3xl font-serif font-bold text-brand-primary">ط§ظ„ط£ظ‚ط³ط§ظ…</h1>
                                ...
                                @can('delete', $category)
                                    <form action="{{ route('admin.categories.destroy', $category) }}" method="POST" class="inline">
                                        ...
                                        <button type="submit" class="js-confirm inline-flex items-center px-3 py-1.5 bg-red-50 text-red-700 rounded-md hover:bg-red-100 hover:text-red-800 font-medium text-xs transition-colors duration-200"
                                                data-confirm-message="ظ‡ظ„ ط£ظ†طھ ظ…طھط£ظƒط¯ ظ…ظ† ط­ط°ظپ ظ‡ط°ط§ ط§ظ„ظ‚ط³ظ…طں">
                                            <svg class="w-3.5 h-3.5 ml-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-4 md:px-6 py-8 text-center text-gray-500">
                            ظ„ط§ طھظˆط¬ط¯ ط£ظ‚ط³ط§ظ… ط­ط§ظ„ظٹط§ظ‹
                        </td>
                    </tr>
                @endforelse
            </tbody>
