    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="w-full lg:w-2/3 space-y-6">
            ...
            <div class="bg-white p-6 rounded shadow">
                <div class="mb-4">
                    <label for="title" class="block text-sm font-medium text-gray-700 mb-2">ط¹ظ†ظˆط§ظ† ط§ظ„طµظپط­ط©</label>
            ...
            <!-- Content -->
            <div class="bg-white p-6 rounded shadow">
                <label for="content" class="block text-sm font-medium text-gray-700 mb-2">ط§ظ„ظ…ط­طھظˆظ‰</label>
        ...
        <div class="w-full lg:w-1/3 space-y-6">
            ...
            <div class="bg-white p-4 rounded shadow">
                <h3 class="font-bold text-gray-800 mb-4 border-b pb-2">ظ†ط´ط± ط§ظ„طھط؛ظٹظٹط±ط§طھ</h3>
            ...
            <div class="bg-white p-4 rounded shadow">
                ...
                <div class="space-y-3">
                    @if($page->featured_image)
                        <div class="mb-2">
                            <p class="text-xs text-gray-500 mb-1">ط§ظ„طµظˆط±ط© ط§ظ„ط­ط§ظ„ظٹط©:</p>
                    ...
                    <div class="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center hover:border-brand-accent transition-colors cursor-pointer" onclick="document.getElementById('featured_image').click()">
                        ...
                        <div id="upload-placeholder">
                            ...
                            <p class="mt-1 text-sm text-gray-600">ط§ظ†ظ‚ط± ظ„طھط؛ظٹظٹط± ط§ظ„طµظˆط±ط©</p>
                        </div>
                    </div>
