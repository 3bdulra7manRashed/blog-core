...
@section('title', 'طھط­ط±ظٹط± ظˆط³ظ…')

@section('content')
<div class="mb-6 flex items-center justify-between">
    <h1 class="text-3xl font-serif font-bold text-brand-primary">طھط­ط±ظٹط± ظˆط³ظ…: {{ $tag->name }}</h1>
    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="w-full lg:w-1/3 space-y-6">
            ...
            <div class="bg-red-50 border border-red-200 p-4 rounded shadow-sm">
                ...
                <p class="text-xs text-red-700 mb-3">ط­ط°ظپ ظ‡ط°ط§ ط§ظ„ظˆط³ظ… ط³ظٹط²ظٹظ„ظ‡ ظ…ظ† ط¬ظ…ظٹط¹ ط§ظ„ظ…ظ‚ط§ظ„ط§طھ ط§ظ„ظ…ط±طھط¨ط·ط© ط¨ظ‡.</p>
                <form action="{{ route('admin.tags.destroy', $tag) }}" method="POST">
                    ...
                    <button type="submit" class="js-confirm w-full px-3 py-2 bg-red-600 text-white rounded hover:bg-red-700 transition-colors text-xs font-medium"
                            data-confirm-message="ظ‡ظ„ ط£ظ†طھ ظ…طھط£ظƒط¯ ظ…ظ† ط­ط°ظپ ظ‡ط°ط§ ط§ظ„ظˆط³ظ…طں ط³ظٹطھظ… ط¥ط²ط§ظ„ط© ط§ظ„ظˆط³ظ… ظ…ظ† ط¬ظ…ظٹط¹ ط§ظ„ظ…ظ‚ط§ظ„ط§طھ ط§ظ„ظ…ط±طھط¨ط·ط© ط¨ظ‡.">
                        ط­ط°ظپ ط§ظ„ظˆط³ظ…
                    </button>
                </form>
            </div>
