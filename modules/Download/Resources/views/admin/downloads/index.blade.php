...
<div class="mb-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-start gap-4">
            ...
            <div>
                <h1 class="text-3xl font-serif font-bold text-brand-primary mb-1">مكتبة الملفات</h1>
    ...
    <div class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-6 mb-8">
        ...
        <form action="{{ route('admin.downloads.store') }}" method="POST" enctype="multipart/form-data" novalidate class="flex flex-col md:flex-row items-end gap-5">
                ...
                <div class="relative">
                    <input type="file" name="file" id="file" required
                           class="block w-full text-sm text-gray-900 border rounded-lg cursor-pointer bg-gray-50 focus:outline-none
                                  ...
                                  {{ $errors->has('file') ? 'border-red-300 bg-red-50' : 'border-gray-200' }}">
                </div>
                @error('file')
                    <p class="text-red-600 text-xs mt-1.5 flex items-center gap-1">{{ $message }}</p>
                @enderror
            ...
            <div class="w-full md:w-auto">
                <button type="submit" class="w-full md:w-auto h-[44px] inline-flex items-center justify-center px-6 py-2 border border-transparent text-sm font-bold rounded-lg text-white bg-brand-primary hover:bg-[#0d9488] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-primary transition-colors duration-200 shadow-sm">
    ...
    <div class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 overflow-hidden">
        <div class="border-b border-gray-100 px-6 py-4 flex items-center justify-between bg-gray-50/50">
            <h3 class="text-base font-bold text-brand-primary">الملفات المرفوعة</h3>
                            ...
                            <tr class="group hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap align-middle" x-data="{ copied: false }">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        {{-- Delete Button --}}
                                        <form action="{{ route('admin.downloads.destroy', $download->id) }}" method="POST" class="inline-flex items-center m-0 p-0"
        ...
        @else
            ...
            <div class="py-12 flex flex-col items-center justify-center text-center">
                ...
                <h3 class="text-lg font-medium text-brand-primary mb-1">المكتبة فارغة</h3>
