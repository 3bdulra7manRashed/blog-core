...
<div class="mb-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div class="flex items-start gap-4">
            ...
            <div>
                <h1 class="text-3xl font-serif font-bold text-[#1F3A6E] mb-1">إدارة المشتركين</h1>
    ...
    <div class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 overflow-hidden">
        <div class="border-b border-gray-100 px-6 py-4 flex items-center justify-between bg-gray-50/50">
            <h3 class="text-base font-bold text-[#1F3A6E]">قائمة المشتركين</h3>
        ...
        @else
            ...
            <div class="py-12 flex flex-col items-center justify-center text-center">
                ...
                <h3 class="text-lg font-medium text-[#1F3A6E] mb-1">لا يوجد مشتركون حالياً</h3>
