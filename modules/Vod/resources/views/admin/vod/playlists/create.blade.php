    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="w-full lg:w-2/3 space-y-4">
            ...
            <div class="bg-white p-6 rounded shadow">
                <!-- Title -->
                <div class="mb-5">
                    <label for="title" class="block text-sm font-medium text-gray-700 mb-2">اسم القائمة <span class="text-red-500">*</span></label>
                ...
                <div>
                   <label for="description" class="block text-sm font-medium text-gray-600 mb-2">وصف مختصر للقائمة <span class="text-gray-400 text-xs font-normal">(اختياري)</span></label>
                ...
                <div class="p-4">
                    ...
                    @else
                        <div class="text-center py-6 text-gray-500 border border-dashed border-gray-200 rounded">
                            ...
                            <a href="{{ route('admin.vod.contents.create') }}" class="text-brand-primary text-xs hover:underline mt-1 block">إضافة جديد</a>
                        </div>
                    @endif
