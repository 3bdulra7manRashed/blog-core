...
@section('content')
    <div class="mb-6 flex items-center justify-between">
        ...
        <a href="{{ route('admin.vod.playlists.create') }}"
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        <th
                            class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[200px]">
                            العنوان</th>
                        <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">عدد
                            الفيديوهات</th>
