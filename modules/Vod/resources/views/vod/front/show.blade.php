...
<div class="container mx-auto px-4 py-8 max-w-5xl">
    {{-- Breadcrumb --}}
    <nav class="flex items-center gap-2 text-sm text-gray-500 mb-6 px-1">
    ...
    <div class="flex flex-col">
        {{-- Video Player --}}
        <div class="relative w-full pb-[56.25%] bg-black rounded-2xl overflow-hidden shadow-2xl z-10">
        ...
        <div class="bg-gray-50 rounded-b-2xl rounded-t-lg -mt-2 pt-8 pb-10 px-6 md:px-10 relative z-0">
            ...
            <div class="max-w-4xl">
                ...
                <div class="flex flex-wrap items-center gap-3 text-sm text-gray-600">
                    ...
                    <div class="flex items-center gap-2">
                        <div class="w-6 h-6 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden text-[10px] font-bold text-gray-500">
            ...
            {{-- Description --}}
            <div class="prose prose-lg text-gray-700 leading-relaxed max-w-4xl prose-headings:font-bold prose-headings:text-gray-900 prose-a:text-brand-primary hover:prose-a:text-brand-accent prose-img:rounded-xl">
                {!! $content->description !!}
            </div>
        </div>
    </div>
