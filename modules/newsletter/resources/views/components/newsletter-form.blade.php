{{--
    ...
    Note: This component is compile-time safe. When the newsletter feature is
    disabled, it renders nothing (self-guards at runtime).
--}}
...
{{-- Feature Guard: Render nothing if newsletter feature is disabled --}}
@unless(feature('newsletter'))
    @php return; @endphp
@endunless
