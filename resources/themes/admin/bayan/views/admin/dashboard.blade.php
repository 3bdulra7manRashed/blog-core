...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        ...
        <a href="{{ route('admin.posts.create') }}" class="flex items-center px-4 md:px-6 py-2 md:py-3 bg-brand-accent text-white rounded-lg shadow-md  hover:bg-teal-700 hover:text-white transition-all duration-200 hover:shadow-lg whitespace-nowrap">
