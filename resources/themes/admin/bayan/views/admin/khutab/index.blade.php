...
@section('content')
    <div class="mb-6 flex items-center justify-between">
        ...
        <x-admin.primary-button href="{{ route('admin.khutab.create') }}">
            خطبة جديدة
    ...
    <div class="mb-6 bg-white p-4 rounded-lg shadow">
        <form method="GET" action="{{ route('admin.khutab.index') }}"
            class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <input type="text" name="search" value="{{ request('search') }}" placeholder="بحث في الخطب..."
            ...
            @if(request()->hasAny(['search', 'status']))
                <a href="{{ route('admin.khutab.index') }}"
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            <td class="px-4 md:px-6 py-4 min-w-[200px]">
                                ...
                                <div class="flex flex-col items-center text-center gap-y-2 md:block md:text-center">
                                    <!-- Post Title -->
                                    <a href="{{ route('khutab.show', $post->slug) }}" target="_blank"
                                    ...
                                    <div class="text-sm text-gray-900 md:hidden">{{ $post->author?->name ?? 'مستخدم محذوف' }}
                                    </div>
                            ...
                            <td class="px-4 md:px-6 py-4 whitespace-nowrap text-sm font-medium text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('admin.khutab.edit', $post) }}"
                                    ...
                                    <form action="{{ route('admin.khutab.destroy', $post) }}" method="POST"
