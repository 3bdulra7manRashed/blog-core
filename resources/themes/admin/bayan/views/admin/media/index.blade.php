...
<div class="mb-6">
    ...
    <form action="{{ route('admin.media.library.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
        ...
        <button type="submit" class="flex items-center justify-center px-4 py-2 bg-brand-accent text-white rounded-lg hover:bg-teal-700 transition-colors shadow-sm hover:shadow-md whitespace-nowrap">
