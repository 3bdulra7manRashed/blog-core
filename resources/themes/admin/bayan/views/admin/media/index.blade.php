...
@section('content')
    <div class="mb-6">
        ...
        <form action="{{ route('admin.media.library.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <button type="submit"
                class="flex items-center justify-center px-4 py-2 bg-brand-primary text-white rounded-lg hover:bg-[#0d9488] transition-colors duration-200 shadow-sm hover:shadow-md whitespace-nowrap">
            ...
            <div
                ...
                <div class="p-3 flex flex-col gap-3 flex-1">
                    ...
                    <div class="flex items-center gap-2 mt-auto">
                        <button type="button" onclick="navigator.clipboard.writeText('{{ $imageUrl }}'); alert('تم النسخ');"
                        ...
                        <form action="{{ route('admin.media.library.destroy', $item->id) }}" method="POST" class="inline-block">
                            ...
                            <button type="submit"
                                ...
                                onclick="return confirm('هل أنت متأكد؟')" title="حذف الملف">
