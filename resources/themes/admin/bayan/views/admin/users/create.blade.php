...
<form action="{{ route('admin.users.store') }}" method="POST" id="user-form">
    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="w-full lg:w-1/3 space-y-6">
            ...
            <!-- Info Card -->
            <div class="bg-teal-50 border border-teal-200 p-4 rounded shadow-sm">
                <div class="flex items-start">
                    <svg class="w-5 h-5 text-teal-600 ml-2 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
