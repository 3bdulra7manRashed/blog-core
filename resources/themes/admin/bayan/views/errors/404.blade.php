...
@section('content')
    <div class="admin-error-page">
        ...
        <div class="admin-error-wrapper">
            ...
            <!-- Error Code -->
            <div class="admin-error-code animate-in delay-1">404</div>

            <!-- Title -->
            <h1 class="admin-error-title animate-in delay-2">العنصر غير موجود في لوحة التحكم</h1>

            <!-- Message -->
            <p class="admin-error-message animate-in delay-2">
                قد يكون الرابط غير صحيح أو تم حذف العنصر من لوحة التحكم.
            </p>
