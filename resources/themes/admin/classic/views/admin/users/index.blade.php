...
<div class="mb-6 flex items-center justify-between flex-wrap gap-4">
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="{{ route('admin.users.create') }}" class="inline-flex items-center px-4 py-2 bg-brand-accent text-white hover:bg-amber-700 hover:text-white rounded-md hover:bg-opacity-90 transition-colors shadow-sm hover:shadow-md">
                        ...
                        <td class="px-4 md:px-6 py-4 text-center">
                            <div class="flex items-center justify-center">
                                <div class="flex-shrink-0 h-8 w-8 ml-3">
                                    <div class="h-8 w-8 rounded-full bg-brand-accent text-white flex items-center justify-center font-semibold text-xs border border-amber-200">
                                    ...
                                    @if(auth()->id() !== $user->id && $user->id !== 1)
                                        ...
                                        @if($user->hasRole('admin'))
                                            ...
                                            <form action="{{ route('admin.users.demote', $user) }}" method="POST" class="inline">
                                                @csrf
                                                <button type="submit" class="js-confirm inline-flex items-center px-2 py-1 bg-amber-50 text-amber-700 rounded hover:bg-amber-100 hover:text-amber-800 font-medium text-xs transition-colors duration-200"
