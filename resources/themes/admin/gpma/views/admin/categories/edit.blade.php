    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="w-full lg:w-2/3 space-y-6">
            ...
            <div class="bg-white p-6 rounded shadow">
                ...
                <div class="@error('description') border border-red-500 rounded @enderror">
                    @php $value = old('description', $category->description ?? ''); @endphp
        ...
        <div class="w-full lg:w-1/3 space-y-6">
            ...
            <div class="bg-white p-4 rounded shadow">
                <h3 class="font-bold text-[#1F3A6E] mb-4 border-b pb-2">الإعدادات</h3>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="order_column" id="order_column" 
                           value="{{ old('order_column', $category->order_column ?? 0) }}" 
            ...
            <div class="bg-white p-4 rounded shadow">
                ...
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between">
                        ...
                        <span class="font-medium text-gray-800">{{ $category->posts_count ?? $category->posts()->count() }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600">تاريخ الإنشاء:</span>
                        <span class="font-medium text-gray-800" dir="ltr">{{ $category->created_at->format('Y-m-d') }}</span>
                    </div>
                </div>
            </div>
