...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        ...
        <a href="{{ route('admin.posts.create') }}" class="flex items-center px-4 md:px-6 py-2 md:py-3 bg-brand-accent text-white rounded-lg shadow-md  hover:bg-[#2f5c8f] hover:text-white transition-all duration-200 hover:shadow-lg whitespace-nowrap">
    ...
    new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: '#3B75B0',
                backgroundColor: 'rgba(59, 117, 176, 0.2)',
                borderWidth: 2,
                tension: 0.4,
                fill: true,
                pointBackgroundColor: '#3B75B0',
