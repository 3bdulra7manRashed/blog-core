...
@section('title', 'إنشاء خطبة جديدة')

@section('content')
<div class="mb-6 flex items-center justify-between">
    <h1 class="text-3xl font-serif font-bold text-brand-primary">إنشاء خطبة جديدة</h1>
...
<form action="{{ route('admin.khutab.store') }}" method="POST" enctype="multipart/form-data" id="post-form">
    @csrf
