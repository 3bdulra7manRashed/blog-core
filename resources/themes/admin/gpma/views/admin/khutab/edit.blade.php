...
<div class="mb-6 flex items-center justify-between">
    <h1 class="text-3xl font-serif font-bold text-brand-primary">تعديل الخطبة</h1>
    <a href="{{ route('admin.khutab.index') }}" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 transition-colors bg-white">
        العودة للقائمة
    </a>
</div>

<form action="{{ route('admin.khutab.update', $post) }}" method="POST" enctype="multipart/form-data" id="post-form">
    @csrf
    @method('PUT')
    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="w-full lg:w-2/3 space-y-6">
            ...
            <div class="bg-white p-6 rounded shadow">
                <div class="mb-4">
                    <label for="title" class="block text-sm font-medium text-gray-700 mb-2">عنوان الخطبة</label>
                    <input type="text" name="title" id="title" value="{{ old('title', $post->title) }}" 
                           ...
                           placeholder="أدخل عنوان الخطبة هنا">
                    @error('title')
                ...
                <div>
                    ...
                    <div class="flex items-center">
                        <span class="text-gray-500 bg-gray-50 border border-l-0 border-gray-300 rounded-r-md px-3 py-2 text-sm" dir="ltr">{{ config('app.url') }}/khutab/</span>
            ...
            <!-- Content Editor -->
            <div class="bg-white p-6 rounded shadow">
                <label for="content" class="block text-sm font-medium text-gray-700 mb-2">محتوى الخطبة</label>
        ...
        <div class="w-full lg:w-1/3 space-y-6">
            ...
            @include('theme::partials.thumbnail-field', [
                ...
                'altHelpText' => 'لأفضل نتائج محركات البحث: اكتب وصفاً يعبر عن الصورة واربطه بموضوع الخطبة الرئيسي.',
                'currentImageUrl' => $post->featured_image_url,
                'currentImageRaw' => $post->featured_image_path,
            ])


            <!-- Categories -->
            <div class="bg-white p-4 rounded shadow">
                <h3 class="font-bold text-[#1F3A6E] mb-4 border-b pb-2">الأقسام</h3>
            ...
            <!-- Tags -->
            <div class="bg-white p-4 rounded shadow">
                <h3 class="font-bold text-[#1F3A6E] mb-4 border-b pb-2">الوسوم</h3>
                <div class="mb-2">
