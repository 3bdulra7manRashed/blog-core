...
@section('title', 'تعديل الوسم: ' . $tag->name)
    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="w-full lg:w-1/3 space-y-6">
            ...
            <div class="bg-white p-4 rounded shadow">
                <h3 class="font-bold text-[#1F3A6E] mb-4 border-b pb-2">الإجراءات</h3>
            ...
            <!-- Stats Card -->
            <div class="bg-white p-4 rounded shadow">
                <h3 class="font-bold text-[#1F3A6E] mb-4 border-b pb-2">إحصائيات</h3>
                <div class="space-y-2 text-sm">
                    <div class="flex justify-between">
                        <span class="text-gray-600">عدد المقالات:</span>
                        <span class="font-medium text-gray-800">{{ $tag->posts_count ?? $tag->posts()->count() }}</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-gray-600">تاريخ الإنشاء:</span>
                        <span class="font-medium text-gray-800" dir="ltr">{{ $tag->created_at->format('Y-m-d') }}</span>
                    </div>
                </div>
            </div>
            ...
            <!-- Quick Tips -->
            <div class="bg-white p-4 rounded shadow">
                <h3 class="font-bold text-[#1F3A6E] mb-3 text-sm">نصائح سريعة</h3>
