...
<div class="mb-6 flex items-center justify-between">
    ...
    <a href="{{ route('admin.tags.create') }}" class="flex items-center px-4 py-2 bg-brand-accent text-white hover:bg-[#2f5c8f] hover:text-white rounded-md hover:bg-opacity-90 transition-colors shadow-sm hover:shadow-md">
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    <th class="px-4 md:px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider min-w-[200px]">الاسم</th>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($tags as $tag)
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-4 md:px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center hidden md:table-cell" dir="ltr">
                            {{ $tag->slug }}
                        </td>
...
{{-- No Pagination for Tags (Collection) --}}
@endsection
