    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="w-full lg:w-2/3 space-y-6">
            ...
            <div class="bg-white p-6 rounded shadow">
                <h3 class="text-lg font-semibold text-[#1F3A6E] mb-4 pb-2 border-b">المعلومات الأساسية</h3>
            ...
            <!-- Password Section -->
            <div class="bg-white p-6 rounded shadow">
                <h3 class="text-lg font-semibold text-[#1F3A6E] mb-4 pb-2 border-b">كلمة المرور</h3>
        ...
        <div class="w-full lg:w-1/3 space-y-6">
            ...
            <div class="bg-white p-4 rounded shadow">
                <h3 class="font-bold text-[#1F3A6E] mb-4 border-b pb-2">الصلاحيات</h3>
            ...
            <!-- User Roles Info -->
            <div class="bg-white p-4 rounded shadow">
                <h3 class="font-bold text-[#1F3A6E] mb-3 text-sm">أنواع المستخدمين</h3>
                <div class="space-y-3">
                    @if(auth()->user()->isSuperAdmin())
                    <div class="flex items-start">
