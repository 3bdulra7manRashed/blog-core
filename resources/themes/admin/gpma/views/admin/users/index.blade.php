...
<div class="mb-6 flex items-center justify-between flex-wrap gap-4">
    ...
    <div class="flex items-center gap-3">
        ...
        <a href="{{ route('admin.users.create') }}" class="inline-flex items-center px-4 py-2 bg-brand-accent text-white hover:bg-[#2f5c8f] hover:text-white rounded-md hover:bg-opacity-90 transition-colors shadow-sm hover:shadow-md">
                        ...
                        <td class="px-4 md:px-6 py-4 text-center">
                            <div class="flex items-center justify-center">
                                <div class="flex-shrink-0 h-8 w-8 ml-3">
                                    <div class="h-8 w-8 rounded-full bg-brand-accent text-white flex items-center justify-center font-semibold text-xs border border-blue-200">
                                    ...
                                    @if(auth()->id() !== $user->id && $user->id !== 1)
                                        ...
                                        @if($user->hasRole('admin'))
                                            ...
                                            <form action="{{ route('admin.users.demote', $user) }}" method="POST" class="inline">
                                                @csrf
                                                <button type="submit" class="js-confirm inline-flex items-center px-2 py-1 bg-blue-50 text-[#3B75B0] rounded hover:bg-blue-100 hover:text-[#1F3A6E] font-medium text-xs transition-colors duration-200"
