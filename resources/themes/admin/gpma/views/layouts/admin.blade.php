...
<head>
    ...
    @vite(['resources/themes/admin/' . config('theme.admin_active', 'classic') . '/assets/css/app.css', 'resources/themes/admin/' . config('theme.admin_active', 'classic') . '/assets/js/app.js'])
    @stack('styles')
</head>
...
<body class="bg-gray-100 font-sans overflow-y-scroll" style="scrollbar-gutter: stable;">
    ...
    @endphp
    @if($plainPassword)
        <div class="mb-4 bg-blue-50 border-l-4 border-blue-500 text-blue-700 p-4 rounded-lg shadow-sm" role="alert"
    ...
    <div id="site-confirm-modal" aria-hidden="true"
        ...
        <div role="dialog" aria-modal="true" aria-labelledby="site-confirm-title"
            ...
            <h3 id="site-confirm-title" class="text-xl font-semibold text-[#1F3A6E] mb-3">تأكيد الإجراء</h3>
            ...
            <div class="flex items-center justify-center gap-4" dir="rtl">
                <button id="site-confirm-ok"
                    class="px-6 py-2.5 rounded-lg bg-red-600 text-white font-medium hover:bg-red-700 transition-colors duration-200 shadow-sm hover:shadow-md">حذف</button>
                <button id="site-confirm-cancel"
                    class="px-5 py-2.5 rounded-lg border border-gray-300 text-gray-700 font-medium hover:bg-gray-50 hover:border-gray-400 transition-colors duration-200">إلغاء</button>
            </div>
        </div>
    </div>
    ...
    <div
        class="md:hidden fixed top-0 left-0 right-0 bg-white shadow-md z-40 px-4 py-3 flex items-center justify-between">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2 group">
            <span class="text-[#1F3A6E] font-bold text-lg">{{ config('app.name') }}</span>
            ...
            <div class="p-6 pt-6 md:pt-6">
                ...
                <a href="{{ route('admin.dashboard') }}" class="flex items-center justify-center gap-2 py-4 mb-6">
                    ...
                    @else
                        ...
                        <span class="text-[#1F3A6E] font-bold text-lg tracking-tight">
                ...
                <nav class="space-y-2">
                    <a href="{{ route('admin.dashboard') }}"
                        class="flex items-center px-4 py-2 rounded-md transition-colors {{ request()->routeIs('admin.dashboard') ? 'bg-brand-accent  text-white hover:text-white hover:bg-[#2f5c8f]' : 'text-gray-700 hover:bg-gray-100' }}">
                    ...
                    <a href="{{ route('admin.posts.index') }}"
                        class="flex items-center px-4 py-2 rounded-md transition-colors {{ request()->routeIs('admin.posts.*') ? 'bg-brand-accent  text-white hover:text-white hover:bg-[#2f5c8f]' : 'text-gray-700 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <x-feature-link feature="khutab" route="admin.khutab.index"
                        class="flex items-center px-4 py-2 rounded-md transition-colors {{ request()->routeIs('admin.khutab.*') ? 'bg-brand-accent text-white hover:text-white hover:bg-[#2f5c8f]' : 'text-gray-700 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.categories.index') }}"
                        class="flex items-center px-4 py-2 rounded-md transition-colors {{ request()->routeIs('admin.categories.*') ? 'bg-brand-accent  text-white hover:text-white hover:bg-[#2f5c8f]' : 'text-gray-700 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.tags.index') }}"
                        class="flex items-center px-4 py-2 rounded-md transition-colors {{ request()->routeIs('admin.tags.*') ? 'bg-brand-accent text-white hover:text-white hover:bg-[#2f5c8f]' : 'text-gray-700 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('admin.media.library.index') }}"
                        class="flex items-center px-4 py-2 rounded-md transition-colors {{ request()->routeIs('admin.media.library.*') ? 'bg-brand-accent text-white hover:text-white hover:bg-[#2f5c8f]' : 'text-gray-700 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @if(vod_enabled())
                        @if(config('features.vod.video') || config('features.vod.audio'))
                            <x-feature-link feature="vod" route="admin.vod.contents.index"
                                class="flex items-center px-4 py-2 rounded-md transition-colors {{ request()->routeIs('admin.vod.contents.*') ? 'bg-brand-accent text-white hover:text-white hover:bg-[#2f5c8f]' : 'text-gray-700 hover:bg-gray-100' }}">
                                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        @if(config('features.vod.playlists'))
                            <x-feature-link feature="vod" route="admin.vod.playlists.index"
                                class="flex items-center px-4 py-2 rounded-md transition-colors {{ request()->routeIs('admin.vod.playlists.*') ? 'bg-brand-accent text-white hover:text-white hover:bg-[#2f5c8f]' : 'text-gray-700 hover:bg-gray-100' }}">
                                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <x-feature-link feature="books" route="admin.books.index"
                        class="flex items-center px-4 py-2 rounded-md transition-colors {{ request()->routeIs('admin.books.*') ? 'bg-brand-accent text-white hover:text-white hover:bg-[#2f5c8f]' : 'text-gray-700 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <x-feature-link feature="download" route="admin.downloads.index"
                        class="flex items-center px-4 py-2 rounded-md transition-colors {{ request()->routeIs('admin.downloads.*') ? 'bg-brand-accent text-white hover:text-white hover:bg-[#2f5c8f]' : 'text-gray-700 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <x-feature-link feature="thoughts" route="admin.thoughts.index"
                        class="flex items-center px-4 py-2 rounded-md transition-colors {{ request()->routeIs('admin.thoughts.*') ? 'bg-brand-accent text-white hover:text-white hover:bg-[#2f5c8f]' : 'text-gray-700 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @if(feature('contact'))
                        <x-feature-link feature="contact" route="admin.messages.index"
                            class="flex items-center justify-between px-4 py-2 rounded-md transition-colors {{ request()->routeIs('admin.messages.*') ? 'bg-brand-accent text-white hover:text-white hover:bg-[#2f5c8f]' : 'text-gray-700 hover:bg-gray-100' }}">
                            <div class="flex items-center">
                                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            @if($unreadMessagesCount > 0)
                                <span
                                    class="inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none {{ request()->routeIs('admin.messages.*') ? 'text-brand-accent bg-white' : 'text-white bg-red-500' }} rounded-full">
                    ...
                    <x-feature-link feature="newsletter" route="admin.campaigns.index"
                        class="flex items-center px-4 py-2 rounded-md transition-colors {{ request()->routeIs('admin.campaigns.*') ? 'bg-brand-accent text-white hover:text-white hover:bg-[#2f5c8f]' : 'text-gray-700 hover:bg-gray-100' }}">
                    ...
                    <x-feature-link feature="newsletter" route="admin.subscribers.index"
                        class="flex items-center px-4 py-2 rounded-md transition-colors {{ request()->routeIs('admin.subscribers.*') ? 'bg-brand-accent text-white hover:text-white hover:bg-[#2f5c8f]' : 'text-gray-700 hover:bg-gray-100' }}">
                        <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @if(feature('manage_admins') || feature('landing') || feature('general_settings'))
                        <div class="pt-4 border-t border-gray-200 mt-4">
                            ...
                            @if(feature('manage_admins'))
                                @can('manage-users')
                                    <x-feature-link feature="manage_admins" route="admin.users.index"
                                        class="flex items-center px-4 py-2 rounded-md transition-colors {{ request()->routeIs('admin.users.*') ? 'bg-brand-accent  text-white hover:text-white hover:bg-[#2f5c8f]' : 'text-gray-700 hover:bg-gray-100' }}">
                                        <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            @if(feature('landing'))
                                <x-feature-link feature="landing" route="admin.settings.landing.edit"
                                    class="flex items-center px-4 py-2 rounded-md transition-colors {{ request()->routeIs('admin.settings.landing.*') ? 'bg-brand-accent text-white hover:text-white hover:bg-[#2f5c8f]' : 'text-gray-700 hover:bg-gray-100' }}">
                                    <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6">
                                        </path>
                            ...
                            @if(feature('general_settings'))
                                <x-feature-link feature="general_settings" route="admin.settings.general"
                                    class="flex items-center px-4 py-2 rounded-md transition-colors {{ request()->routeIs('admin.settings.general') ? 'bg-brand-accent text-white hover:text-white hover:bg-[#2f5c8f]' : 'text-gray-700 hover:bg-gray-100' }}">
                                    <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="pt-4 border-t border-gray-200 mt-4">
                        ...
                        <a href="{{ route('profile.edit') }}"
                            class="flex items-center px-4 py-2 rounded-md transition-colors {{ request()->routeIs('profile.edit') ? 'bg-brand-accent text-white hover:text-white hover:bg-[#2f5c8f]' : 'text-gray-700 hover:bg-gray-100' }}">
                            <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <form method="POST" action="{{ route('logout') }}" class="mt-2">
                            @csrf
                            <button type="submit"
                                class="flex items-center w-full text-right px-4 py-2 rounded-md text-gray-700 hover:bg-gray-100 transition-colors">
                                <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
