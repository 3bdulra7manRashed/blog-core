...
<body class="bg-gray-100 font-sans overflow-y-scroll" style="scrollbar-gutter: stable;">
    ...
    @if($plainPassword)
        <div class="mb-4 bg-blue-50 border-l-4 border-blue-500 text-blue-700 p-4 rounded-lg shadow-sm" role="alert"
            ...
            <div class="flex items-center">
                ...
                <p class="font-medium">���� ������ ��: <strong>{{ $plainPassword }}</strong> (���� ��� ����� ���)</p>
            </div>
        </div>
    @endif
    ...
    <div id="site-confirm-modal" aria-hidden="true"
        ...
        <div role="dialog" aria-modal="true" aria-labelledby="site-confirm-title"
            ...
            <h3 id="site-confirm-title" class="text-xl font-semibold text-gray-800 mb-3">����� �������</h3>

            <p id="site-confirm-message" class="text-gray-600 mb-4">�� ��� ����Ͽ</p>
            ...
            <div id="site-confirm-input-wrapper" class="mb-4 hidden">
                <input id="site-confirm-input" type="text" class="w-full border rounded px-3 py-2 text-center"
                    placeholder="���� ���� ������� ���" />
                <p id="site-confirm-help" class="text-sm text-gray-500 mt-2">���� <strong>���</strong> �������</p>
            ...
            <div class="flex items-center justify-center gap-4" dir="rtl">
                <button id="site-confirm-ok"
                    class="px-6 py-2.5 rounded-lg bg-red-600 text-white font-medium hover:bg-red-700 transition-colors duration-200 shadow-sm hover:shadow-md">���</button>
                    ...
                    @if(feature('manage_admins'))
                        @can('manage-users')
                            <div class="pt-4 border-t border-gray-200 mt-4">
                                <p class="px-4 py-2 text-xs font-semibold text-gray-500 uppercase">����� ����</p>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            window.showConfirmModal = function (message, form, expectedText = null, placeholder = null, okText = '�����') {
                currentForm = form;
                ...
                if (expectedText && inputWrapper) {
                    ...
                    if (helpEl) helpEl.innerHTML = `���� <strong>${expectedText}</strong> �������`;
            ...
            window.confirmDelete = function (form, message = '�� ��� ����� �� ��� ��� ������ �������') {
                // Open the modal
                window.showConfirmModal(message, form, null, null, '���');
            ...
            document.addEventListener('click', function (e) {
                ...
                const message = confirmBtn.getAttribute('data-confirm-message') || '�� ��� ����� �� ����� ��� ��������';
                ...
                const okText = confirmBtn.getAttribute('data-confirm-ok-text') || '�����';
