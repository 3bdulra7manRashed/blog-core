...
<body class="bg-gray-100 font-sans overflow-y-scroll" style="scrollbar-gutter: stable;">
    ...
    <div
        ...
        <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2 group">
            <span class="text-writer-primary font-bold text-lg">{{ config('app.name') }}</span>
        ...
        <aside id="sidebar"
            ...
            <div class="p-6 pt-6 md:pt-6">
                ...
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2 group mb-6">
                    <span class="text-writer-primary font-serif font-bold text-lg tracking-tight whitespace-nowrap">
                        {{ config('app.name') }}
                    </span>
                    <span
