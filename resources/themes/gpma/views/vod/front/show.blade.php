...
@section('content')
    <div class="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <nav class="flex items-center gap-3 text-lg text-gray-500 mb-6 px-1">
            ...
            <a href="{{ $content->type == 'video' ? route('videos.index') : route('audios.index') }}"
        ...
        <div class="flex flex-col">
            ...
            <div class="bg-gray-50 rounded-b-2xl rounded-t-lg -mt-2 pt-8 pb-10 px-6 md:px-10 relative z-0">
                    ...
                    <div class="flex flex-wrap items-center gap-3 text-lg text-gray-600">
                        ...
                        @if($content->author)
                            <div class="flex items-center gap-2">
                                <div
                                    class="w-7 h-7 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden text-xs font-bold text-gray-500">
                ...
                {{-- Description --}}
                <div
                    class="prose prose-xl text-gray-700 leading-loose max-w-4xl prose-headings:font-bold prose-headings:text-gray-900 prose-a:text-brand-primary hover:prose-a:text-brand-accent prose-img:rounded-xl">
                    {!! $content->description !!}
                </div>
            </div>
        </div>
